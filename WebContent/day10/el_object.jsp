...
<dl>
	...
	<dt>cookie</dt>
	<dd>브라우저에 저장된 쿠키값 가져올 때 </dd>
	<dt>pageContext</dt>
	<dd>요청을 처리하는 페이지 정보저장 객체  , 예)\${pageContext.request.remoteAddr } : \${pageContext.request.remoteAddr }</dd>
	<dd>el을 사용할 때는 jsp 내장객체를 제공하지 않습니다. pageContext 만 있고 이것으로 나머지 내장객체에 접근합니다.
	<%
		//pageContext 를 jsp 내장객체를 리턴하는 메소드가있습니다.
		//jsp request 객체 대신에
